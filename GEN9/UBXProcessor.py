...
class UbxProcessorEventType(Enum):
    NAVCLOCK_EVENT = auto()
...
class UBXProcessor():
    ...
    def __init__(self):
        self._last_message = {}
        self._listeners = {}
        for event_type in UbxProcessorEventType:
    ...
    def _nav_clock(self, tubx_msg):
        ...
        self._notify(UbxProcessorEventType.NAVCLOCK_EVENT, msg)
    ...
    def _nav_sat(self, tubx_msg):
        ...
        for i in range(1, tubx_msg.numSvs+1):
            ...
            msg['sats'].append(sat)
        self._notify(UbxProcessorEventType.NAVSAT_EVENT, msg)
    ...
    def _tim_tp(self, tubx_msg):
        ...
        self._notify(UbxProcessorEventType.TIMEPULSE_EVENT, msg)
    ...
    def _rmx_rawx(self, tubx_msg):
        ...
        self._notify(UbxProcessorEventType.RAWX_EVENT, msg)
    ...
    def _tim_svin(self, tubx_msg):
        ...
        self._notify(UbxProcessorEventType.SURVEYIN_EVENT, msg)
        
        if ('NAV-PVT' in self._last_message):
            if (msg['valid'] == 1) and ((self._last_message['NAV-PVT']['msg']).fixType == 5):
                self._notify(UbxProcessorEventType.SURVEY_DONE, self._last_message['NAV-PVT']['msg'])
